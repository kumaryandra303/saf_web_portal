    ...
    <section className="py-20 bg-gradient-to-br from-saf-red-600 to-saf-dark-900 text-white">
      <div className="max-w-4xl mx-auto px-4 text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/contact" className="bg-white text-saf-red-600 px-8 py-4 rounded-lg font-semibold hover:scale-105 transition-all inline-flex items-center justify-center">
